...
import { searchProcesses } from "@/lib/mockData";
    ...
    <MainLayout>
      ...
      >
        <div className="container mx-auto px-4">
          {/* Loading state */}
          {isLoading && (
            <ResultsTable results={[]} isLoading={true} />
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">
                Los identificadores de actores judiciales son códigos únicos e irrepetibles que 
                protegen la identidad real de los funcionarios.
              </p>
            </div>
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">
                Los documentos y resoluciones judiciales mantienen su carácter público, 
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-muted-foreground">
                Implementación de políticas FIA (Identificación y Autenticación) y FDP 
                (Protección de Datos) para máxima seguridad.
              </p>
            </div>
          </div>
        </div>
